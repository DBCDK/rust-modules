  ...
  internal = rec {
    ...
    crates = {
      ...
      "iana-time-zone" = rec {
        ...
        version = "0.1.48";
        edition = "2018";
        sha256 = "1c38ckxczvqf4fbb0ay8yag2rc2fak5hqxy0rsff67lby8a0fyi3";
        authors = [
      ...
      "once_cell" = rec {
        ...
        version = "1.14.0";
        edition = "2018";
        sha256 = "1h6pc09c5yf1vyyb32sp12k3j9w853vfn22bl9yxgjiikswm8wig";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "activation" "combaseapi" "minwinbase" "minwindef" "ntdef" "objbase" "profileapi" "roapi" "std" "sysinfoapi" "timezoneapi" "winerror" "winstring" ];
      };
